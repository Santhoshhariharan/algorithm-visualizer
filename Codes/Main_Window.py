...
class Window:
    def __init__(self, root):
        ...
        try:
            self.root.iconbitmap("Algorithm-Visualizer-main/Images/algorithm.ico")
        except:
            img = PhotoImage("Algorithm-Visualizer-main/Images/algorithm.ico")
    ...
    def Run1(self):
        ...
        # if backtracking is selected
            ...
            if self.AlgoNameVar.get() == "Sudoku":
                ...
                # icon of the window
                try:
                    self.root.iconbitmap("Algorithm-Visualizer-main/Images/sudoku.ico")
                except:
                    img = PhotoImage("Algorithm-Visualizer-main/Images/sudoku.ico")
                    self.root.tk.call('wm', 'iconphoto', self.root._w, img)
                ...
                if self.AlgoNameVar.get() == "N-Queens":
                    try:
                        self.root.iconbitmap("Algorithm-Visualizer-main/Images/nqueens.ico")
                    except:
                        img = PhotoImage("Algorithm-Visualizer-main/Images/nqueens.ico")
                        self.root.tk.call('wm', 'iconphoto', self.root._w, img)
                else:
                    try:
                        self.root.iconbitmap("Algorithm-Visualizer-main/Images/knight.ico")
                    except:
                        img = PhotoImage("Algorithm-Visualizer-main/Images/knight.ico")
                        self.root.tk.call('wm', 'iconphoto', self.root._w, img)
                # create a new frame for the speed slider and buttons

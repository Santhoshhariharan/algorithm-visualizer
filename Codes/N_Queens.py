...
class N_queen:
    def __init__(self, size, speed):
        ...
        # Icon of the window
        pygame.display.set_icon(pygame.image.load("Algorithm-Visualizer-main/Images/nqueens.png"))
        # Diagonals List
        self.diagonal1 = {}
        self.diagonal2 = {}
        # Column list
        ...
        # image the on queen
        self.queen = pygame.image.load('Algorithm-Visualizer-main/Images/nqueens1.png')

...
class Knight():
    def __init__(self, size, speed):
        ...
        pygame.display.set_icon(pygame.image.load("Algorithm-Visualizer-main/Images/knight.png"))
        self.SIDE = 600
        self.block = self.SIDE // self.n
        self.win = pygame.display.set_mode((self.SIDE, self.SIDE+130))
        self.K_SIDE = (self.block * 3) // 4
        self.knight_img = pygame.image.load('Algorithm-Visualizer-main/Images/knight1.png')
